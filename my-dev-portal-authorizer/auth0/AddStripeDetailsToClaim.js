...
exports.onExecutePostLogin = async (event, api) => {
    api.accessToken.setCustomClaim('stripeCustomerId', event.user.app_metadata.stripeCustomerId);
    api.accessToken.setCustomClaim('stripeSubscriptionId', event.user.app_metadata.stripeSubscriptionId);
  };

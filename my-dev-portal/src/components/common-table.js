...
function CommonTable(props) {
  ...
  const borderClass = withBorder ? "comon-table--with-border" : "";
  return (
    <>
      <table
        ref={tableRef}
        className={`comon-table ${className} ${borderClass}`}
        style={style}
      >
        {emptyState}
        <tbody>
          <tr
            className="comon-table__header"
                ...
                if (row === null) {
                  return (
                    <td
                      ...
                      style={{ minHeight: minRowHeight, justifyContent }}
                    />
                  );
                }

...
const Auth0Dashboard = (props) => {
    ...
    useEffect(() => {
      ...
      if(checkout_session_id) {
        fetch(`${process.env.REACT_APP_DEV_PORTAL_API_SERVER}/checkout/sessions/${checkout_session_id}`, {
          method: 'POST',
          headers: {
        ...
        fetch(`${process.env.REACT_APP_DEV_PORTAL_API_SERVER}/stripe/customers?email=${user.email}`, {
          headers: {
